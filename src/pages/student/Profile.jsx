      ...
      <div className="card">
        <div style={{ display: "flex", gap: 18, alignItems: "center", marginBottom: 24 }}>
          ...
          <div>
            ...
            <p className="text-muted mt-0">Student · {user.id}</p>
          </div>
        </div>
        <div className="doc-grid">
          ...
          <div className="doc-field"><div className="doc-field-label">Semester</div><div className="doc-field-value">{user.semester}</div></div>
          <div className="doc-field"><div className="doc-field-label">Section</div><div className="doc-field-value">{user.section}</div></div>
